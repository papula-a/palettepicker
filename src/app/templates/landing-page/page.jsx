    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.bgColor }}>
        ...
        <div className="absolute inset-0">
          <svg className="w-full h-full" viewBox="0 0 1440 320">
            <path
              fill="#ffffff"
              fillOpacity="0.5"
              d="M0,128L60,101.3C120,75,240,21,360,10.7C480,0,600,32,720,69.3C840,107,960,149,1080,160C1200,171,1320,149,1380,138.7L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
            ></path>
          </svg>
        </div>
        <h1
      ...
      <section id="features" className="py-16 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="bg-yellow-100 border rounded-lg p-6 shadow-lg">
            ...
            <p className="mt-2 text-gray-600">
              Join sessions that fit your schedule, whether you're at home or on
              the go.
            </p>
          </div>
          {/* Feature Item */}
      ...
      <section className="py-40 px-4 bg-blue-50 text-center relative">
        ...
        <blockquote className="mt-4 italic text-gray-600 relative z-10">
          "This meditation program has changed my life. I feel more centered and
          focused."
        </blockquote>
        <p className="mt-2 text-gray-700 relative z-10">- Sarah Johnson</p>
        <blockquote className="mt-4 italic text-gray-600 relative z-10">
          "The sessions are easy to follow and have helped me develop a regular
          practice."
        </blockquote>
