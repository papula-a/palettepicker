    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.bgColor }}>
      ...
      <section className="py-16 px-4 text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          Simone Biles is an American gymnast and one of the most decorated
          gymnasts in Olympic history. Known for her extraordinary athleticism,
          she has inspired millions with her performances and resilience.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="mt-2 text-gray-600">
                Won 4 Gold and 1 Bronze medal, becoming the most decorated
                gymnast at a single Olympics.
              </p>
            </div>
          </div>
          ...
          <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div className="p-4">
              ...
              <p className="mt-2 text-gray-600">
                Secured 5 Gold medals, further solidifying her status as a top
                gymnast.
              </p>
            </div>
          </div>
